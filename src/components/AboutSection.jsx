      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
       {/* LEFT SIDES OF ABOUT */}
        <div className='space-y-6'>
          ...
          <a href="/cv/Experience.pdf" className='px-4 py-2 rounded-full border border-primary text-primary hover:bg-primary/20 transition-colors duration-300'>
            Download CV
          </a>
        </div>
        </div>
          ...
          <div className='gradient-border p-3 card-hover'>
            ...
            <div className='gradient-border p-3 card-hover'>
             ...
             <div className='flex items-start gap-4'>
              ...
              {/* CONTENT OF LEFT SIDE OF ABOUT IN FORTH BOX  */}
              <div className='text-left'>
                <h4 className='font-semibold text-lg'>Back-end Developement </h4>
                
                <p className='text-muted-foreground'>
                Building robust back-end systems and APIs to support front-end applications, ensuring data integrity and security.                
                </p>
              </div>
            </div>
          </div>
