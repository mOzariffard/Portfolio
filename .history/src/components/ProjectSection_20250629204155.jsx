...
const ProjectSection = () => {
    ...
    const imgProjects=[imgProjects.current, imgProjects.current, imgProjects.current, imgProjects.current, imgProjects.current, imgProjects.current];

   
    useEffect(() => {
        imgProjects.current.each((card , index)=>{
            gsap.fromTo(
                card,
                {
                    y: 50,
