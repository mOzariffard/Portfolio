                        ...
                        <div key={index} className='group bg-card rounded-lg overflow-hidden shadow-xs card-hover'>
                            ...
                            <div className='p-6 '> 
                                <div className='flex flex-wrap gap-2 mb-4'>
                                    {project.tag.map((tag)=>(
                                        <span className='px-2 py-1 text-xs border-primary hover:bg-primary/85 animate-bounce-delay-2  font-medium rounded-full bg-secondary text-secondary-foreground '>
                                            {tag}
                                        </span>
                                    ))}
                                </div>
