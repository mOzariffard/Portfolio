import { Github, Instagram, Linkedin, Mail, Phone, Twitch, Twitter } from 'lucide-react'
            ...
            <div className='bg-card p-8 rounded-lg shadow-xs'>
                ...
                <form className='space-y-6'>
                    ...
                    <div>
                        ...
                        name='name'
                        required
                        className='w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-primary resize-none h-32'2 
