...
const ProjectSection = () => {
    ...
    useEffect(()=>{
        gsap.to(image1Ref.current, { rotation: 360, duration: 2 });
        gsap.to(image2Ref.current, { scale: 1.2, duration: 1.5 });
        gsap.to(image3Ref.current, { x: 100, duration: 1 });
    },[]);
                ...
                {projects.map((project,index)=>(
                    <div key={index} className='group bg-card rounded-lg overflow-hidden shadow-xs card-hover'>
                        ...
                        <div className='h-48 overflow-hidden'>
                            ...
                            className='w-full h-full object-cover transmition-transform duration-500 group-hover:scale-110' />
                        </div>
