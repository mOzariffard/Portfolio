      ...
      <div className='grid sm:grid-cols-1 md:grid-cols-2 ls: grid-cols-3 gap-8'>
          {certificates.map((certificate , index)=>(
            ...
            <div className='h-50 overflow-hidden'>
              <h1 className='text-2xl font-bold text-center mb-4 p-4 bg-secondary/50 text-secondary-foreground'>
                {certificate.title}
              </h1>

              <div className='flex flex-col items-center justify-center ga-3'>
                <a href={certificate.url} target='_blank' className=' certificate-btn p-4 text-lg  hover:bg-primary font-medium rounded-full bg-secondary text-secondary-foreground'>
                  View My Certificate
                </a>
              </div>
